//
// This suppresses TypeScript errors when importing remote modules
//

declare module 'https://unpkg.com/alpinejs*' {
  ...
  export interface XAttributes {
    ...
    _x_doHide: () => void
    _x_doShow: () => void
    _x_toggleAndCascadeWithTransitions: (el: ElementWithXAttributes, val: boolean, show: () => void, hide: () => void) => void
  ...
  export interface Alpine {
     ...
     */
    addScopeToNode: (node: Element, data: Record<string, unknown>, referenceNode?: ElementWithXAttributes) => () => void
    /**
     ...
     * @returns
     */
    extractProp: <T_3 extends string | boolean>(el: ElementWithXAttributes, name: string, fallback: T_3 | (() => T_3), extract?: boolean) => unknown
    /**
     ...
     */
    throttle<T_7 extends (...args: Parameters<T_7>) => void>(func: T_7, limit?: number): (...args: Parameters<T_7>) => void
    /**
     ...
     */
    initTree(el: ElementWithXAttributes, walker?: (el: ElementWithXAttributes, callback: WalkerCallback) => any, intercept?: WalkerCallback): void
    /**
